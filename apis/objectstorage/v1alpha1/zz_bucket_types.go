...
type BucketInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/lschulte19/crossplane-test/apis/identity/v1alpha1.Compartment
	...
	// +crossplane:generate:reference:type=github.com/lschulte19/crossplane-test/apis/kms/v1alpha1.Key
