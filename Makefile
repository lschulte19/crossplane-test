...
export TERRAFORM_PROVIDER_VERSION := 6.21.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-oci
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-oci/6.21.0
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-oci_v6.21.0
